...
const edicaoSchema = z
  .object({
    ...
    corFundoCardComissoes: corSecaoSchema,
    opacidadeFundoCardComissoes: opacidadeSchema,
    corTextoCardComissoes: corPublicaSchema,
    corTextoSecundarioCardComissoes: corPublicaSchema,
    corAcentoCardComissoes: corPublicaSchema,

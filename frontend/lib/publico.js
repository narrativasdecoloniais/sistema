...
export function montarPropsPaginaEdicao(edicao, atividades, ehEdicaoAtual) {
  ...
  return {
    ...
    corFundoCardComissoes: edicao?.corFundoCardComissoes || "PAPEL",
    opacidadeFundoCardComissoes: edicao?.opacidadeFundoCardComissoes ?? 100,
    corTextoCardComissoes: edicao?.corTextoCardComissoes || "TINTA",
    corTextoSecundarioCardComissoes: edicao?.corTextoSecundarioCardComissoes || "TINTA",
